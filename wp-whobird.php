...
/**
  Plugin Name: whoBIRD observations                       Requires at least: 6.0                                  Tested up to: 6.8.1
  Requires PHP: 7.4                                       License: GPL-3.0-or-later                               License URI: https://www.gnu.org/licenses/gpl-3.0.html
  License File: LICENSES/GPL-3.0-or-later.txt
  Version: 1.0.0                                          Contributors: @evlist                                   Tags: block, birds, observations, gutenberg, taxonomy
